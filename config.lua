...
Config.Zones = {
	...
	ls1 = {
		Pos   = vector3(1697.3953, 3706.8704, 34.5232),
		Name  = "Customs Sandy Shores",
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {2.0, 4.0, 6.0, 8.0} -- Max 8%
	},
	modBrakes = {
		label = TranslateCap('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.0, 3.0, 4.0} -- Max 4%
	},
	modTransmission = {
		label = TranslateCap('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {2.0, 3.5, 5.0} -- Max 5%
	},
	modSuspension = {
		label = TranslateCap('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {1.5, 2.0, 2.5, 3.0, 3.5} -- Max 3.5%
	},
	modArmor = {
	...
	wheels = {
		...
		wheelColor = TranslateCap('wheel_color'),
	...
	resprays = {
		...
		parent = 'cosmetics',
		color1 = TranslateCap('primary'),
		color2 = TranslateCap('secondary'),
		pearlescentColor = TranslateCap('pearlescent'),
	},
	color1 = {
