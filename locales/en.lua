...
-- Extras / Hardcoded UI
  ['perform_maintenance'] = "Perform maintenance on all 4 sides of the vehicle.",
  ['welding'] = "Welding",
  ['hammering'] = "Hammering",
  ['mods_applied'] = "~g~Modifications Applied!~s~ You can now bill the customer.",
  ...
  ['quote_saved'] = "Quote saved. Amount: ~g~$%s.~s~ Please perform the work on the vehicle.",
  ['vehicle_unmodified'] = "Vehicle unmodified.",
  ['custom_cancelled'] = "Customizations cancelled.",
  ['bill_custom'] = "Bill Customization",
  ['no_pending_bill'] = "No pending custom bill found for this customer.",
  ['create_invoice'] = "Create Invoice",
  ['plate'] = "Plate",
  ['parts_cost'] = "Parts Cost",
  ['labor_fees'] = "Labor Fees",
  ['custom_labor'] = "Customization + Labor",
  ['confirm'] = "Confirm",
  ['cancel'] = "Cancel",
  ['back'] = "Back",
  ['no_turbo'] = "No Turbo",
